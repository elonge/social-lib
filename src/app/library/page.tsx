...
import { Search, Plus, Library as LibraryIcon, MoreVertical, Book as BookIcon } from "lucide-react";
        ...
        <div className="max-w-5xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">My Shelf</h1>
            </div>
            <Link 
              href="/capture"
      ...
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 py-8">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <h2 className="text-xl font-semibold text-zinc-900 mb-2">No books found</h2>
            <p className="text-zinc-500 max-w-xs mb-8">
              Start building your digital library by capturing your physical books.
            </p>
            <Link 
              href="/capture"
              className="bg-zinc-900 text-white px-8 py-3 rounded-full font-semibold hover:bg-zinc-800 transition-all"
            >
              Capture My First Book
            </Link>
          </div>
        )}
      </main>
